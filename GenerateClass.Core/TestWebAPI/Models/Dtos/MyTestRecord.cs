...
{
	public partial class MyTestRecord
	{
		/// <summary>
		/// Id
		/// </summary>
		...
		/// Prop
		/// </summary>
		public TestRecord<int, int> Prop { get; set; }

		/// <summary>
		/// Prop1
		/// </summary>
		public TestRecord<char, int> Prop1 { get; set; }

		public MyTestRecord()
		{
		}

		public MyTestRecord(TestRecord<int, int> Prop)
		{
		}
	}
}
