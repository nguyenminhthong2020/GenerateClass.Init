...
{
	public partial class newTestObjListClass1
	{
		/// <summary>
		/// Id
		/// </summary>
		...
		/// B1
		/// </summary>
		public (int, string, object?, (char, object)) B1 { get; set; }

		public newTestObjListClass1()
		{
		}

		public newTestObjListClass1(string A1, (int, string, object, (char, object)) B1)
		{
		}
	}
}
